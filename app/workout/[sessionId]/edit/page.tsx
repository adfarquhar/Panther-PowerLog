    ...
    <div className="container mx-auto p-4 md:p-6 max-w-2xl">
      ...
      {workoutExercises.length === 0 && (
        <div className="text-center py-10 px-6 bg-white rounded-lg shadow">
          ...
          <h3 className="mt-2 text-xl font-medium">No exercises added yet</h3>
          <p className="mt-1 text-sm">Get started by adding an exercise to your session.</p>
        </div>
      )}
        ...
        <div className="space-y-4">
          {workoutExercises.map((woExercise) => (
            ...
            >
              ...
              {woExercise.notes && (
                 <p className="mt-3 text-sm italic">Session Notes: {woExercise.notes}</p>
              )}
            </div>
          ))}
        </div>
